export const en = {
  ...
  reservationContactFirstName: 'First name',
  reservationContactLastName: 'Last name',
  reservationContactEmail: 'Email',
  reservationContactPhone: 'Phone',
  reservationContactNotes: 'Notes',
  reservationContactMarketing: 'I agree to marketing communications',
  reservationContactOtpLabel: 'SMS code',
  reservationContactSubmit: 'Confirm booking',
  bookingProgressBranch: 'Branch',
  bookingProgressService: 'Service',
  bookingProgressEmployee: 'Barber',
  bookingProgressDatetime: 'Time',
  bookingProgressContact: 'Contact',
  ...
  bookingOtpConfirm: 'Confirm booking',
  bookingSubmitting: 'Submitting…',
  bookingOtpVerifying: 'Verifying…',
  bookingCouponVerifying: 'Verifying…',
  bookingContactYourDetails: 'Your details',
  bookingOtpTitle: 'Phone verification',
  bookingOtpHint: 'Enter the SMS code sent to',
