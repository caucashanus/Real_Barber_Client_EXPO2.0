...
export const cs: Record<TranslationKey, string> = {
  ...
  searchScheduleSubtitle: 'Kdo kdy pracuje',
  ...
  contactsOperatorStatusOpeningSoon: 'Zákaznická podpora za chvíli otevírá',
  contactsOperatorStatusClosingSoon: 'Zákaznická podpora za chvíli zavírá',
  contactsOperatorHoursAlertTitle: 'Pracovní doba živé zákaznické podpory:',
  contactsOperatorHoursWeekdays: 'Všední dny: 08:30–21:30',
  contactsOperatorHoursWeekend: 'Víkendy: 09:30–18:30',
  ...
  customerAiFabAccessibility: 'Chat s asistentem Rbíčkem',
  customerAiSheetTitle: 'Asistent Rbíček',
  ...
  referralTitle: 'Doporuč nás',
  referralHeroTitle: 'Získej {amount} RB Coins',
  referralHeroSubtitle:
    'Pozvi kamaráda — po jeho první návštěvě získáš {amount} RB Coins.',
  referralShare: 'Sdílet odkaz',
  referralShareDialogTitle: 'Pozvánka do Real Barber',
  referralComingSoon: 'Brzy',
  referralProgramInactive: 'Referral program momentálně není aktivní.',
  referralInvitesSection: 'Pozvaní',
  referralInvitesEmpty: 'Zatím nemáte žádné pozvánky.',
  referralStatsTotal: 'Pozváno',
  referralStatsQualified: 'Splněno',
  referralStatsRewarded: 'Odměněno',
  referralStatsPending: 'Čeká',
  referralStatsEarned: 'Získáno celkem',
  referralLoadError: 'Nepodařilo se načíst doporučení.',
  referralTtlNote: 'Platnost pozvání: {days} dní od zadání telefonu.',
  referralHomeHeadline: 'Doporuč nás kamarádovi a získej {czk} Kč',
  referralHomeLead:
    'Sdílej svou pozvánku a získej odměnu, jakmile kamarád dorazí na svou návštěvu.',
  referralHomeInviteCta: 'Pozvat',
  referralHomeMyInvitesCta: 'Mé pozvání',
  referralRulesTitle: 'Podmínky odměny',
  referralRule1Title: 'Sdílej pozvánku',
  referralRule1Body: 'Sdílíš svůj osobní referenční odkaz nebo QR kód.',
  referralRule2Title: 'Nový zákazník',
  referralRule2Body:
    'Pozvaný musí být nový zákazník, který u nás ještě nemá vytvořený účet.',
  referralRule3Title: 'První návštěva',
  referralRule3Body:
    'Pozvaný zadá telefon přes odkaz a do {ttl} dní dorazí na první návštěvu.',
  referralRule4Title: 'Odměna pro tebe',
  referralRule4BodyPrefix: 'Po splnění podmínek ti připíšeme {rbc} RBC.',
  referralRule4RbcLink: 'Co jsou to RBC?',
  referralRulesShareCta: 'Odeslat pozvánku',
  referralRulesQrCta: 'Zobrazit QR kód',
  referralShareSheetTitle: 'Sdílet pozvánku',
  referralShareSms: 'SMS',
  referralShareMessageBody:
    'Přidej se ke mně a více než 10 tis. zákazníků, kteří si Real Barber zamilovali. Přijmi moji pozvánku pomocí odkazu níže:',
  referralShareEmailSubject: 'Real Barber: pozvánka',
  referralShareErrorAuth: 'Přihlaste se znovu.',
  referralShareErrorUnavailable: 'Doporučení není momentálně dostupné.',
  referralShareErrorGeneric: 'Nepodařilo se připravit odkaz ke sdílení.',
  referralQrLead: 'Nech kamaráda naskenovat QR kód.',
  referralRbcSheetTitle: 'Co jsou to RBC?',
  referralRbcWhatTitle: 'Co to je',
  referralRbcWhatBody:
    'RBC (Real Barber Coiny) jsou věrnostní mince v tvé peněžence Real Barber.',
  referralRbcUseTitle: 'Co s nimi můžeš dělat',
  referralRbcUseBody:
    'Můžeš jimi platit služby při návštěvě a sledovat zůstatek i historii v peněžence. Můžeš je taky poslat komukoli: kamarádovi nebo třeba holiči, jen tak jako dárek, nebo jako dýško.',
  referralRbcWalletLink: 'Otevřít peněženku',
  referralRbcValueTitle: 'Jakou mají hodnotu',
  referralRbcValueBody:
    '1 RBC odpovídá 1 Kč. Za splnění podmínek referralu získáš {rbc} RBC, odměnu v hodnotě {czk} Kč. Zůstatek uvidíš v peněžence.',
  referralInvitesTitle: 'Mé pozvání',
  referralInvitesEmptyState: 'Nemáš žádná pozvání.',
  referralProgressAccepted: 'Přijal pozvánku',
  referralProgressBooking: 'Vytvořil rezervaci',
  referralProgressVisit: 'Návštěva',
  referralProgressReward: 'Odměna',
  referralInviteIneligibleCaption: 'Toto bohužel nepůjde',
  referralInviteExpiredCaption: 'Vypršelo',
  referralInviteDaysRemaining: 'Zbývá {days} dní',
  referralInviteCopyPhone: 'Kopírovat telefon',
  referralInfoDeadlineTitle: 'Lhůta',
  referralInfoDeadlineBody:
    'Od zadání telefonu na pozvánce: do {days} dní registrace, rezervace a dokončená návštěva. Nestačí jen rezervovat.',
  referralInfoIneligibleTitle: 'Promo pro tohoto uživatele neplatí',
  referralInfoIneligibleBody:
    'Dotyčný u nás už má vytvořený účet, proto referral promo akci nelze uplatnit. Odměna se vztahuje jen na nové zákazníky.',
  referralInfoGotIt: 'Rozumím',
  walletReferralPromoTitle: 'Doporuč nás',
  walletReferralPromoBodyPrefix: 'Odměna ',
  walletReferralPromoBodySuffix: ' na tebe čeká.',
  walletReferralPromoOpenA11y: 'Otevřít',
  walletReferralPromoDismissA11y: 'Skrýt promo banner',
