...
export const cs: Record<TranslationKey, string> = {
  ...
  tripDetailCancelBooking: 'Opravdu chcete zrušit rezervaci?',
  tripDetailCancelButton: 'Zrušit',
  tripDetailRepeatReservation: 'Opakovat',
  tripDetailCancelConfirmIntro: 'Rezervace je naplánovaná na',
  tripDetailCancelConfirmAtBranch: 'na pobočce',
  tripDetailCancelConfirmNote:
  ...
  tripDetailCancelNo: 'Nechat být',
  tripDetailCancelYes: 'Zrušit rezervaci',
