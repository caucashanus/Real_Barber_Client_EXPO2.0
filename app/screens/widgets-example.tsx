/**
 * 1:1 copy of expo/examples/with-widgets App.tsx for widget + Live Activity testing.
 * @see https://github.com/expo/examples/tree/master/with-widgets
 */
...
export default function WidgetsExampleScreen() {
  ...
  if (Platform.OS !== 'ios') {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.hint}>iOS only — requires a development build with expo-widgets.</Text>
      </View>
    );
  }
