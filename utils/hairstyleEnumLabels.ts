...
const HAIR_TYPE_LABELS: Record<Locale, EnumLabels> = {
  ...
  uk: {
    straight: 'Пряме',
    slightly_wavy: 'Легко хвилясте',
    wavy: 'Хвилясте',
    strongly_wavy: 'Сильно хвилясте',
    curly: 'Кучеряве',
    strongly_curly: 'Дуже кучеряве',
    african: 'Африканський тип',
    european: 'Європейський тип',
    asian: 'Азійський тип',
    latin: 'Латиноамериканський тип',
  },
};
...
const HAIR_PROPERTY_LABELS: Record<Locale, EnumLabels> = {
  ...
  uk: {
    fine: "Тонке",
    medium_thickness: "Середньої товщини",
    thick_strand: "Товсте",
    coarse: "Грубе",
    thin: "Тонке",
    dense: "Густе",
    sparse: "Рідке",
    normal_density: "Нормальна густина",
    pliant: "Поступливе",
    unpliant: "Непоступливе",
    voluminous: "Об'ємне",
    flat: "Плоске",
    dry: "Сухе",
    oily: "Жирне",
...
const HAIR_LENGTH_LABELS: Record<Locale, EnumLabels> = {
  ...
  uk: {
    very_short: 'Дуже коротке',
    short: 'Коротке',
    medium_short: 'Середньо коротке',
    medium: 'Середнє',
    medium_long: 'Середньо довге',
    long: 'Довге',
    very_long: 'Дуже довге',
  },
};
