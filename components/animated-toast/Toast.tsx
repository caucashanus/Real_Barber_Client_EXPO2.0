...
import type { Toast as ToastType, ToastType as ToastVariant } from '@/components/animated-toast/types';
...
interface ToastProps {
  toast: ToastType;
  index: number;
  /** Odsazení shora — absolute děti ignorují padding rodiče. */
  anchorTop?: number;
}
...
export function Toast({ toast, index, anchorTop = 0 }: ToastProps) {
    ...
    <Animated.View
      ...
      style={[
        ...
        animatedStyle,
        {
          ...
          marginBottom: 0,
          position: 'absolute',
          top: toast.options.position === 'top' ? anchorTop : undefined,
